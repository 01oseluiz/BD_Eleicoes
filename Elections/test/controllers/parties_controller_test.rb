...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { idPerson: @party.idPerson, partyAbbv: @party.partyAbbv, partyLogo: @party.partyLogo, partyName: @party.partyName } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { idPerson: @party.idPerson, partyAbbv: @party.partyAbbv, partyLogo: @party.partyLogo, partyName: @party.partyName } }
